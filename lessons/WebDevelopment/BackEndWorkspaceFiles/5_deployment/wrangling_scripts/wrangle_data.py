...
def return_figures():
  ...
  # as a line chart
    ...
    graph_two = [
        go.Bar(
            x=df.country.tolist(), y=df.hectaresarablelandperperson.tolist()
        )
    ]
...
# fourth chart shows rural population vs arable land
    ...
    graph_five = [
        go.Bar(x=df_five.country.tolist(), y=df_five.ruralpopulation.tolist())
    ]
    ...
    return [
        ...
        dict(data=graph_five, layout=layout_five),
    ]